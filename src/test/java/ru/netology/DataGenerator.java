...
public class DataGenerator {
    ...
    public static class Registration {
        ...
        public static DataGenerator.UserData generateUser(String locale) {
            return new DataGenerator.UserData(generateCity(), generateName(locale), generatePhone(locale));
        }
    }
